...
struct HostFunctionCommandListRegularArguments : TestCaseArgumentContainer {
    ...
    HostFunctionCommandListRegularArguments() : measureCompletionTime(*this, "MeasureCompletion", "Add completion time in the measurement."),
...
struct HostFunctionCommandListRegular : TestCase<HostFunctionCommandListRegularArguments> {
    using TestCase<HostFunctionCommandListRegularArguments>::TestCase;

    std::string getTestCaseName() const override {
        return "HostFunctionCmdListRegular";
    }
