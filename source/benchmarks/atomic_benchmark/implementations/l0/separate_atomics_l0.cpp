...
static TestResult run(const SeparateAtomicsArguments &arguments, Statistics &statistics) {
    ...
    ASSERT_ZE_RESULT_SUCCESS(zeCommandListAppendMemoryFill(tmpCmdList, buffer, data.initialValue, data.sizeOfDataType, totalBufferSize, nullptr, 0, nullptr));
    ...
    kernelDesc.pKernelName = "separate_atomics";
...
static RegisterTestCaseImplementation<SeparateAtomics> registerTestCase(run, Api::L0);
