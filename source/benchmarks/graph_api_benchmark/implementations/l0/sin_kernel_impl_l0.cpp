...
TestResult SinKernelGraphL0::init() {
    ...
    TestResult kernelA_res = L0::KernelHelper::loadKernel(*levelzero, "graph_api_benchmark_kernel_assign.cl", "kernel_assign", &kernelAssign, &moduleAssign, nullptr);
    if (kernelA_res != TestResult::Success) {
        return kernelA_res;
    }
    TestResult kernelB_res = L0::KernelHelper::loadKernel(*levelzero, "graph_api_benchmark_kernel_sin.cl", "kernel_sin", &kernelSin, &moduleSin, nullptr);
