...
class SubmitGraphTest : public ::testing::TestWithParam<std::tuple<Api, bool, bool, bool, size_t, size_t, bool>> {
};
...
TEST_P(SubmitGraphTest, Test) {
    ...
    args.noEvents = std::get<3>(GetParam());
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Combine(
        ...
        ::testing::Values(false, true),      // noEvents
