...
[[maybe_unused]] static const inline RegisterTestCase<MpiAllReduce> registerTestCase{};

class MpiAllReduceTest : public ::testing::TestWithParam<std::tuple<uint32_t, uint32_t, UsmMemoryPlacement, UsmMemoryPlacement, MpiStatisticsType>> {};
