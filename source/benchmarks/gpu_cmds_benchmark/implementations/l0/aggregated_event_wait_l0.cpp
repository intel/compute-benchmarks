...
static TestResult run(const AggregatedEventWaitArguments &arguments, Statistics &statistics) {
    ...
    ze_event_counter_based_external_aggregate_storage_desc_t aggregateStorageDesc{
        ...
        .completionValue = incrementValue};
...
static RegisterTestCaseImplementation<AggregatedEventWait> registerTestCase(run, Api::L0);
