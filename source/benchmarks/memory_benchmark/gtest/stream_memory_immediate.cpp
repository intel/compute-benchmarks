...
[[maybe_unused]] static const inline RegisterTestCase<StreamMemoryImmediate> registerTestCase{};
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Combine(
        ...
        ::testing::Values(1 * megaByte, 8 * megaByte, 16 * megaByte, 32 * megaByte, 64 * megaByte, 128 * megaByte, 256 * megaByte, 512 * megaByte),
        ::testing::Values(false, true)));

INSTANTIATE_TEST_SUITE_P(
    StreamMemoryImmediateTestLIMITED,
    StreamMemoryImmediateTest,
    ::testing::Combine(
