...
static TestResult run(const ReadImageArguments &arguments, Statistics &statistics) {
...
static RegisterTestCaseImplementation<ReadImage> registerTestCase(run, Api::OpenCL);
