...
static TestResult run(const ExecGraphArguments & arguments, Statistics & statistics) {
...
[[maybe_unused]] static RegisterTestCaseImplementation<ExecGraph> registerTestCase(run, Api::SYCL);