...
struct KernelSwitchPriorityImmArguments : TestCaseArgumentContainer {
    ...
    KernelSwitchPriorityImmArguments()
...
struct KernelSwitchPriorityImm : TestCase<KernelSwitchPriorityImmArguments> {
    using TestCase<KernelSwitchPriorityImmArguments>::TestCase;

    std::string getTestCaseName() const override {
        return "KernelSwitchPriorityImm";
    }

    std::string getHelp() const override {
        return "submits kernels on queues with different priorities and measures kernel switch latency on single queue on immediate cmd lists.";
    }
};