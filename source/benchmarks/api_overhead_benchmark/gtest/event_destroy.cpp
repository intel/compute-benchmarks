...
[[maybe_unused]] static const inline RegisterTestCase<EventDestroy> registerTestCase{};

class EventDestroyTest : public ::testing::TestWithParam<std::tuple<bool, bool, EventScope, EventScope, uint32_t, bool>> {
};

TEST_P(EventDestroyTest, Test) {
    EventDestroyArguments args{};
    args.api = Api::L0;
