...
__kernel void elementwise_sum_10_##DATA_TYPE(__global DATA_TYPE *dest, \
    ...
    dest[gid] = src0[gid] + src1[gid] + src2[gid] + src3[gid] + src4[gid] + src5[gid] + src6[gid] + src7[gid] + src8[gid] + src9[gid]; \
}
